...
<link rel="stylesheet" href="./hellopt/static/swiper.min.css">
<link href="./HelloPT/css" rel="stylesheet">
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/font.css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/default.css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/xeicon.min.css">

<link rel="stylesheet" href="${pageContext.request.contextPath}/static/style.css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/content.css">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static//moment.min.js"></script>
<script src="${pageContext.request.contextPath}/static/jquery-1.8.3.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/static/jquery-ui.min.js"></script>
<script src="${pageContext.request.contextPath}/static/jquery.menu.js"></script>
<script src="${pageContext.request.contextPath}/static/common.js"></script>
<script src="${pageContext.request.contextPath}/static/wrest.js"></script>
<script src="${pageContext.request.contextPath}/static/placeholders.min.js"></script>

<script src="${pageContext.request.contextPath}/static/script.js"></script>
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/font-awesome.min.css">
