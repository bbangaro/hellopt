...
<body>
    ...
    <header id="hd" class="ease" style="z-index: 9999;">
		...
		<div class="userName">
				...
				<span>
					<img class="alarmImg" src="${pageContext.request.contextPath}/resources/images/meeting/notification.png"/>
					<input type="text" id="alarm" class="alarm" value=""/>
				</span>
				<span class="uName">${user.username}님</span>
			</sec:authorize>
		</div>
							...
							<ul class="artist_depth02">
								...
								<li><a
									href="${pageContext.request.contextPath}/admin/meetingAdmin">Manage
										Meeting</a></li>
								<li><a
									href="${pageContext.request.contextPath}/admin/traineradmin">Managee
										Trainer</a>
								<li>
								<li><a
