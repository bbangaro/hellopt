		...
		<div class="con-inner sub-sub">
			...
			<div class="sub-content">
			  <div class="basic-table">
			    <form class="opens" action="updateclassok?classIdx=${classDetail.classIdx }" method="post">
			        <ul>
			          <li>
			            <label for="className" class="sound_only">수업 이름</label>
			            <input type="text" name="className" id="className" required value="${classDetail.className }" placeholder="수업 이름">
			          </li>
			          <li>
			          ...
			          <li>
			            ...
			            <input style="width:95%; display: inline-block;" type="number" name="classLength" id="classLength" required value="${classDetail.classLength }" placeholder="수업 기간(주 단위로 입력 가능합니다.)" min="1" max="12">
			          ...
			          <li>
			            ...
			            <input type="number" name="price" id="price" required value="${classDetail.price }" placeholder="가격">
			          </li>
			        </ul>
